    ...
    <div className="border-b border-custom">
      ...
      <div className="px-4 pb-4">
        ...
        <div className="-mt-12 sm:-mt-16 mb-4">
          <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full border-4 border-primary bg-primary">
            <UserAvatar
              src={user.avatar}
        ...
        <div className="flex justify-end mb-4 gap-2">
          <button className="px-3 py-1.5 sm:px-4 sm:py-2 border border-custom rounded-full text-primary hover:bg-hover transition-colors duration-200 text-sm sm:text-base">
            Edit Profile
          </button>
          <button className="px-3 py-1.5 sm:px-4 sm:py-2 bg-accent-blue text-white rounded-full hover:bg-accent-hover transition-colors duration-200 text-sm sm:text-base">
            Follow
          </button>
        </div>
        ...
        <div className="mb-4">
          <div className="flex items-center space-x-1 mb-1">
            ...
            {user.verified && (
              <svg viewBox="0 0 24 24" className="w-4 h-4 sm:w-5 sm:h-5 fill-current text-accent-blue" aria-label="Verified account">
          ...
          <div className="flex flex-wrap gap-x-3 sm:gap-x-4 gap-y-2 text-secondary text-xs sm:text-sm mb-4">
            {user.location && (
          ...
          {/* Stats */}
          <div className="flex space-x-3 sm:space-x-4 text-primary text-sm sm:text-base">
            <span>
